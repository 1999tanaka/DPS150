...
test("CSV contains the experiment and telemetry fields", () => {
  ...
  assert.match(csv, /^timestamp,record_type,elapsed_s,A,formula_base_b_v,T_s,cycle,command_v/);
  assert.match(csv, /measurement,0\.050,2\.000,7\.000,1\.000,1,9\.8540,0\.1000,9\.7900,0\.5280,5\.1690,0\.048,12,CV,OK,1/);
});
